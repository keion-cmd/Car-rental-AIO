...
// time. requireAuth(STAFF) here is the gate for every route in this
// (authenticated) group; each page under it also calls requireAuth with
// its own (equal or higher) minimum role, since a layout guard alone would
// let a STAFF session render an OWNER-only page's shell before the page
// itself redirects. /admin/login lives outside this group specifically so
// this gate never runs on it — see app/admin/login/page.tsx.
